...
public class IssueServiceImpl implements IssueService {
	...
	/*
	 * @Autowired private IssueRepository issueRepository; Autowired önerilmiyor.
	 * Constructor kullanılması best-practice. Çünkü final ile işaretlersek, sadece
	 * constructor içinde değer atayabiliyoruz. Böylece güvenliği sağlıyoruz.
	 */
